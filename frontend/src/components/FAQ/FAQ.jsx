...
export default function FAQ() {
  const faq = [
    ...
    { question: "보호중인 동물과 공고중인 동물의 차이가 무엇인가요?", answer: "동물을 구조하면 일정 기간 동안 원래 주인이 동물을 찾을 수 있도록 공고를 올립니다. 그 후 기간이 지나면 유기동물로 간주하여 동물의 소유권이 관할 지방자치단체로 이전되고, 보호중인 동물은 입양 신청자가 절차를 통해 입양할 수 있습니다." },
