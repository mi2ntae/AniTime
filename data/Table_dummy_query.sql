...
CREATE TABLE `adoptionform` (
  ...
  PRIMARY KEY (`formNo`),
  KEY `FK_Animal_TO_AdoptionForm_generalNo` (`generalNo`),
  CONSTRAINT `FK_Animal_TO_AdoptionForm_generalNo` FOREIGN KEY (`generalNo`) REFERENCES `member` (`memberNo`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Member_TO_AdoptionForm_generalNo` FOREIGN KEY (`generalNo`) REFERENCES `member` (`memberNo`) ON DELETE CASCADE ON UPDATE CASCADE
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='입양동물 목록 즐겨찾기';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='채팅메세지 관련 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='채팅방 목록 조회 및 채팅방 대상자는 확인 가능한 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='보호소 회원, 비회원의 공통된 회원 정보 저장을 위한 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notice` (
  ...
  KEY `FK_Member_TO_Notice` (`generalNo`),
  CONSTRAINT `FK_Member_TO_Notice` FOREIGN KEY (`generalNo`) REFERENCES `member` (`memberNo`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-08-01 16:53:10
